abbreviations = {
    ...
    'bias': {
        'NOB': 'no',
        'ASU': 'assurative',
        'ASU+': '(intensive) assurative',
        'HPB': 'hyperbolic',
        'HPB+': '(intensive) hyperbolic',
        'COI': 'coincidental',
        'COI+': '(intensive) coincidental',
        'ACP': 'acceptive',
        'ACP+': '(intensive) acceptive',
        'RAC': 'reactive',
        'RAC+': '(intensive) reactive',
        'STU': 'stupefactive',
        'STU+': '(intensive) stupefactive',
        'CTV': 'contemplative',
        'CTV+': '(intensive) contemplative',
        'DPV': 'desperative',
        'DPV+': '(intensive) desperative',
        'RVL': 'revelative',
        'RVL+': '(intensive) revelative',
        'GRT': 'gratificative',
        'GRT+': '(intensive) gratificative',
        'SOL': 'solicitive',
        'SOL+': '(intensive) solicitive',
        'SEL': 'selective',
        'SEL+': '(intensive) selective',
        'IRO': 'ironic',
        'IRO+': '(intensive) ironic',
        'EXA': 'exasperative',
        'EXA+': '(intensive) exasperative',
        'LTL': 'literal',
        'LTL+': '(intensive) literal',
        'CRR': 'corrective',
        'CRR+': '(intensive) corrective',
        'EUP': 'euphemistic',
        'EUP+': '(intensive) euphemistic',
        'SKP': 'skeptical',
        'SKP+': '(intensive) skeptical',
        'CYN': 'cynical',
        'CYN+': '(intensive) cynical',
        'CTP': 'contemptive',
        'CTP+': '(intensive) contemptive',
        'DSM': 'dismissive',
        'DSM+': '(intensive) dismissive',
        'IDG': 'indignative',
        'IDG+': '(intensive) indignative',
        'SGS': 'suggestive',
        'SGS+': '(intensive) suggestive',
        'PPV': 'propositive',
        'PPV+': '(intensive) propositive',
    },
    'version': {
        'PRC': 'processual',
        'CPT': 'completive',
...
def make_abbreviation_table():
    abbreviation_table = {}
    for category_name, category_abbreviations in abbreviations.items():
        for abbr, name in category_abbreviations.items():
            full_name = '{} {}'.format(name, category_name).title()
            assert abbr not in abbreviation_table # Check for duplication.
            abbreviation_table[abbr] = full_name
...
def verify_abbreviations():
    ...
    assert sorted(all_abbreviations) == sorted(abbreviation_table.keys())
verify_abbreviations()

# unimplemented source material:
"""
1+ M
