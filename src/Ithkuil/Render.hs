...
renderCase (Affinitive ACT) = "ai'i"
renderCase (Affinitive ASI) = "au'u"
renderCase (Affinitive ESS) = "ei'i"
renderCase (Affinitive TRM) = "eu'u"
renderCase (Affinitive SEL) = "ëu'u"
renderCase (Affinitive CFM) = "ou'u"
renderCase (Affinitive DEP) = "oi'i"
renderCase (Affinitive VOC) = "ui'i"
-- Spatio-Temporal I (Series 3 vowels + glottal stop)
renderCase (SpatioTemporal1 LOC) = "ia'a"
renderCase (SpatioTemporal1 ATD) = "iä'ä"
renderCase (SpatioTemporal1 ALL) = "ie'e"
renderCase (SpatioTemporal1 ABL) = "ië'ë"
renderCase (SpatioTemporal1 ORI) = "ëo'o"
renderCase (SpatioTemporal1 IRL) = "iö'ö"
renderCase (SpatioTemporal1 INV) = "io'o"
renderCase (SpatioTemporal1 NAV) = "iü'ü"
-- Spatio-Temporal II (Series 4 vowels + glottal stop)
renderCase (SpatioTemporal2 CNR) = "ua'a"
renderCase (SpatioTemporal2 ASS) = "uä'ä"
renderCase (SpatioTemporal2 PER) = "ue'e"
renderCase (SpatioTemporal2 PRO) = "uë'ë"
renderCase (SpatioTemporal2 PCV) = "ëa'a"
renderCase (SpatioTemporal2 PCR) = "uö'ö"
renderCase (SpatioTemporal2 ELP) = "uo'o"
renderCase (SpatioTemporal2 PLM) = "uü'ü"
