...
func TestWrite_NonDefaultSlots(t *testing.T) {
...
func TestWrite_Ultimate(t *testing.T) {
...
func TestWrite_WithSlotVIII(t *testing.T) {
	f := g.MinimalFormative("ml")
...
func TestWrite_MovedGlottal_Cases37To52(t *testing.T) {
...
func TestWrite_NoMovedGlottal_OtherCases(t *testing.T) {
...
func TestWrite_CnCaShortcut_AllVariants(t *testing.T) {
...
func TestWrite_WithAffixes(t *testing.T) {
	f := g.MinimalFormative("ml")
...
func TestWrite_THMVcElision_KeepsForMinimal(t *testing.T) {
...
func TestWrite_AssertiveOBS_MonosyllabicElision(t *testing.T) {
...
func TestWrite_ShortForm_AntepenultKeepsLong(t *testing.T) {
...
func TestWrite_ShortForm_NonDefaultVvNoElision(t *testing.T) {
...
func TestWrite_ShortForm_WithSlotI_NoElision(t *testing.T) {
...
func TestWrite_ANTPaddingNilSlotIX(t *testing.T) {
...
func TestWrite_ShortcutW_Series1(t *testing.T) {
...
// form wins.
func TestWrite_ShortcutOnlyWhenItShortens(t *testing.T) {
	cases := []struct {
		name  string
		stem  g.Stem
		persp g.Perspective
...
func TestWrite_ShortcutY_Series1(t *testing.T) {
...
func TestWrite_ShortcutWithConcat(t *testing.T) {
