...
func TestParse_NonDefault(t *testing.T) {
...
func TestParse_Verbal(t *testing.T) {
...
func TestParse_ElidedVc(t *testing.T) {
...
func TestParse_RoundTripMinimal(t *testing.T) {
	original := g.MinimalFormative("ml")
	rom := Formative(original)
...
func TestParse_ConsonantInitial(t *testing.T) {
...
func TestParse_SlotVIIAffixPair(t *testing.T) {
...
func TestParse_CanonicalWord(t *testing.T) {
	...
	f, err := ParseFormative("maţřëullait")
	if err != nil {
	...
	if got := Formative(f); got != "maţřëullait" {
		t.Errorf("render = %q, want canonical %q", got, "maţřëullait")
	}
}

func TestParse_SlotI_Type1(t *testing.T) {
...
func TestParse_SlotI_Type2(t *testing.T) {
...
func TestParse_ShortcutW_Series1(t *testing.T) {
...
func TestParse_ShortcutY_Series3(t *testing.T) {
...
func TestParse_ShortcutW_Series2(t *testing.T) {
...
func TestParse_ShortcutWithConcat(t *testing.T) {
...
func TestParse_ShortcutWithAffix(t *testing.T) {
...
func TestParse_Stem1_Completive_ProspectiveAspect_Locative(t *testing.T) {
...
func TestParse_SentencePrefix_StrippedSilently(t *testing.T) {
	cases := []struct {
		in, equiv string
	}{
		{"çamlala", "amlala"},
...
func TestParse_GlottalCaseAlone(t *testing.T) {
...
func TestParse_RoundTrip_ConsonantInitial(t *testing.T) {
	...
	reparsed, err := ParseFormative(rom)
	if err != nil {
		t.Fatal(err)
	}
...
func TestParse_WithSlotVIIAffix(t *testing.T) {
...
func TestParse_WithSlotVIII(t *testing.T) {
...
func TestParse_SlotVIIIVerbal(t *testing.T) {
...
func TestParse_RoundTrip_WithSlotVII(t *testing.T) {
...
func TestParse_RoundTrip_WithSlotVIII(t *testing.T) {
...
func TestParse_RoundTripVariants(t *testing.T) {
	cases := []struct {
		name string
		f    g.Formative
	}{
